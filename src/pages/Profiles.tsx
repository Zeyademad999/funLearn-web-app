  ...
  return (
    <div className="min-h-screen bg-gradient-secondary p-8">
      ...
      <div className="max-w-4xl mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <div className="flex flex-col items-center space-y-4">
              <div className="relative">
                ...
                <div className="absolute -bottom-2 -right-2 bg-muted rounded-full px-3 py-1 flex items-center gap-1 shadow-soft border-2 border-background">
                  ...
                  <span className="font-bold text-sm">{profile.stars}</span>
                </div>
              </div>
        ...
        <button className="bg-card/50 border-4 border-dashed border-primary/30 rounded-2xl p-8 hover:border-primary hover:bg-card/80 hover:scale-105 transition-all active:scale-95 flex flex-col items-center justify-center space-y-4 min-h-[240px]">
